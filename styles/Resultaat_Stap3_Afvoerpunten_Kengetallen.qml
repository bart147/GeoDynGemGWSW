...
<qgis styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyMaxScale="1" version="3.28.4-Firenze" minScale="100000000" simplifyLocal="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="1" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" simplifyAlgorithm="0">
  <flags>
  ...
  <elevation symbology="Line" type="IndividualFeatures" zoffset="0" respectLayerSymbol="1" clamping="Relative" showMarkerSymbolInSurfacePlots="0" zscale="1" extrusionEnabled="0" extrusion="0" binding="Centroid">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" enableorderby="0" referencescale="-1">
    <symbols>
      <symbol type="marker" force_rhr="0" is_animated="0" frame_rate="10" name="0" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SvgMarker" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="https://data.gwsw.nl/img/Rioolgemaal.svg?fill=#000000&amp;fill-opacity=1&amp;outline=#232323&amp;outline-opacity=1&amp;outline-width=0.2" name="name"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeightUnit="Percentage" fontFamily="Arial" fieldName="Beginpunt_Afvoerrelatie" fontKerning="1" fontUnderline="0" capitalization="0" fontSize="10" multilineHeight="1" legendString="Aa" textOpacity="1" fontItalic="0" forcedItalic="0" fontStrikeout="0" forcedBold="0" textOrientation="horizontal" allowHtml="0" previewBkgrdColor="255,255,255,255" namedStyle="Standaard" blendMode="0" isExpression="0" fontWeight="50" fontSizeUnit="Point" textColor="50,50,50,255" fontLetterSpacing="0" fontWordSpacing="0" useSubstitutions="0">
        <families/>
      ...
      <text-format placeDirectionSymbol="0" decimals="3" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" addDirectionSymbol="0" multilineAlign="3" plussign="0" formatNumbers="0" wrapChar="" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0"/>
      <placement lineAnchorPercent="0.5" repeatDistanceUnits="MM" yOffset="0" distUnits="MM" maxCurvedCharAngleIn="25" placementFlags="10" repeatDistance="0" geometryGeneratorType="PointGeometry" rotationAngle="0" lineAnchorTextPoint="FollowPlacement" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" layerType="PointGeometry" rotationUnit="AngleDegrees" quadOffset="4" overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" offsetUnits="MM" fitInPolygonOnly="0" dist="0" centroidWhole="0" overlapHandling="PreventOverlap" centroidInside="0" placement="6" offsetType="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" allowDegraded="0" lineAnchorType="0" polygonPlacementFlags="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" xOffset="0" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGenerator="" priority="5" geometryGeneratorEnabled="0"/>
      <rendering scaleMax="7500" unplacedVisibility="0" labelPerPart="0" obstacleFactor="1" maxNumLabels="2000" obstacleType="1" upsidedownLabels="0" scaleMin="0" limitNumLabels="0" fontMaxPixelSize="10000" fontMinPixelSize="3" obstacle="1" drawLabels="1" fontLimitPixelSize="0" zIndex="0" scaleVisibility="1" mergeLines="0" minFeatureSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory labelPlacementMethod="XHeight" scaleBasedVisibility="0" lineSizeType="MM" penWidth="0" enabled="0" showAxis="1" spacing="5" minScaleDenominator="0" sizeScale="3x:0,0,0,0,0,0" opacity="1" diagramOrientation="Up" rotationOffset="270" width="15" lineSizeScale="3x:0,0,0,0,0,0" penColor="#000000" sizeType="MM" height="15" backgroundColor="#ffffff" minimumSize="0" maxScaleDenominator="1e+08" penAlpha="255" spacingUnit="MM" scaleDependency="Area" barWidth="5" backgroundAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" direction="0">
      <fontProperties style="" bold="0" underline="0" strikethrough="0" italic="0" description="MS Shell Dlg 2,9.75,-1,5,50,0,0,0,0,0"/>
  ...
  <DiagramLayerSettings zIndex="0" dist="0" placement="0" showAll="1" priority="0" obstacle="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="gemeente" configurationFlags="None"/>
    ...
    <field name="Bemalingsgebied_ID_Afvoerpunt_2" configurationFlags="None"/>
    ...
    <field name="Leidingtypen_In_Stelsel" configurationFlags="None"/>
    <field name="Stelselnamen" configurationFlags="None"/>
    <field name="Leidingberging_m3" configurationFlags="None"/>
    <field name="Knooppuntberging_m3" configurationFlags="None"/>
    <field name="Stelselberging_m3" configurationFlags="None"/>
    <field name="Laagste_Doorlaatniveau_mNAP" configurationFlags="None"/>
    <field name="Laagste_Drempelniveau_mNAP" configurationFlags="None"/>
    <field name="Aantal_Doorlaten" configurationFlags="None"/>
    <field name="Aantal_Drempels" configurationFlags="None"/>
    <field name="Stap2_datum" configurationFlags="None"/>
    <field name="Gemengd_Aangesloten_ha" configurationFlags="None"/>
    <field name="Hemelwater_Aangesloten_ha" configurationFlags="None"/>
    <field name="Verbeterd_Hemelwater_Aangesloten_ha" configurationFlags="None"/>
    <field name="Vuilwater_Aangesloten_ha" configurationFlags="None"/>
    <field name="DIT_Aangesloten_ha" configurationFlags="None"/>
    <field name="Oppervlaktewater_Aangesloten_ha" configurationFlags="None"/>
    <field name="Maaiveld_Aangesloten_ha" configurationFlags="None"/>
    <field name="Aangesloten_Oppervlak_Stelsel_ha" configurationFlags="None"/>
    ...
    <field name="Drinkwater_Particulier_m3h" configurationFlags="None"/>
    <field name="Drinkwater_Zakelijk_m3h" configurationFlags="None"/>
    <field name="Drinkwater_Totaal_m3h" configurationFlags="None"/>
    <field name="Aantal_VEs_Eigen_Rioleringsgebied" configurationFlags="None"/>
    <field name="DWA_VEs_m3h" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_2124_m3h" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_2529_m3h" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_3039_m3h" configurationFlags="None"/>
    ...
    <field name="Bouwprojecten_IDs_Onderbemalingen" configurationFlags="None"/>
    <field name="DWA_BAG_Onderbemalingen_m3h" configurationFlags="None"/>
    <field name="Aantal_Adressen_In_Onderbemalingen" configurationFlags="None"/>
    <field name="Drinkwater_Part_Onderbem_m3h" configurationFlags="None"/>
    <field name="Drinkwater_Zak_Onderbem_m3h" configurationFlags="None"/>
    <field name="Drinkwater_Totaal_Onderbem_m3h" configurationFlags="None"/>
    <field name="DWA_VEs_Onderbemalingen_m3h" configurationFlags="None"/>
    <field name="Aantal_VEs_Onderbemalingen" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_Onderbem_2124_m3h" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_Onderbem_2529_m3h" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_Onderbem_3039_m3h" configurationFlags="None"/>
    <field name="Extra_DWA_Periode_Onderbem_4050_m3h" configurationFlags="None"/>
    <field name="POC_Theorie_Gemengd_Onderbem_m3h" configurationFlags="None"/>
    <field name="POC_Theorie_VGS_Onderbem_m3h" configurationFlags="None"/>
    <field name="POC_Theorie_Totaal_Onderbem_m3h" configurationFlags="None"/>
    ...
    <field name="Sommatie_DWA_VEs_m3h" configurationFlags="None"/>
    <field name="Sommatie_Aantal_VEs" configurationFlags="None"/>
    <field name="Sommatie_Extra_DWA_Periode_2124_m3h" configurationFlags="None"/>
    <field name="Sommatie_Extra_DWA_Periode_2529_m3h" configurationFlags="None"/>
    <field name="Sommatie_Extra_DWA_Periode_3039_m3h" configurationFlags="None"/>
    <field name="Sommatie_Extra_DWA_Periode_4050_m3h" configurationFlags="None"/>
    ...
    <field name="Knooppuntberging_mm" configurationFlags="None"/>
    <field name="Stelselberging_mm" configurationFlags="None"/>
    <field name="Maximale_Vultijd_Droogweer_h" configurationFlags="None"/>
    <field name="Minimale_Vultijd_Droogweer_h" configurationFlags="None"/>
    <field name="Maximale_Ledigingstijd_h" configurationFlags="None"/>
    <field name="Minimale_Ledigingstijd_h" configurationFlags="None"/>
    <field name="POC_Theorie_Beschikbaar_DWA_obv_BAG_m3h" configurationFlags="None"/>
    <field name="POC_Theorie_Beschikbaar_DWA_obv_Drinkwater_m3h" configurationFlags="None"/>
    <field name="POC_Theorie_Beschikbaar_DWA_obv_VEs_m3h" configurationFlags="None"/>
    <field name="POC_Praktijk_Eigen_Rioleringsgeb_DWA_obv_BAG_m3h" configurationFlags="None"/>
    <field name="POC_Praktijk_Eigen_Rioleringsgeb_DWA_obv_Drinkwater_m3h" configurationFlags="None"/>
    <field name="POC_Praktijk_Eigen_Rioleringsgeb_DWA_obv_VEs_m3h" configurationFlags="None"/>
    <field name="POC_Praktijk_Eigen_Rioleringsgeb_DWA_obv_BAG_mmh" configurationFlags="None"/>
    <field name="POC_Praktijk_Eigen_Rioleringsgeb_DWA_obv_Drinkwater_mmh" configurationFlags="None"/>
    <field name="POC_Praktijk_Eigen_Rioleringsgeb_DWA_obv_VEs_mmh" configurationFlags="None"/>
  </fieldConfiguration>
  <aliases>
    <alias index="0" field="Bemalingsgebied_ID_Afvoerpunt" name=""/>
    <alias index="1" field="fid" name=""/>
    <alias index="2" field="gemeente" name=""/>
    <alias index="3" field="naam" name=""/>
    <alias index="4" field="Bemalingsgebied_ID" name=""/>
    <alias index="5" field="Stap1_Datum" name=""/>
    <alias index="6" field="Rioolgemaal" name=""/>
    ...
    <alias index="14" field="Bemalingsgebied_ID_Afvoerpunt_2" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="Bemalingsgebied_ID_Afvoerpunt_2" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="Bemalingsgebied_ID_Afvoerpunt_2" unique_strength="0" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="Bemalingsgebied_ID_Afvoerpunt_2" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="Bemalingsgebied_ID_Afvoerpunt_2"/>
