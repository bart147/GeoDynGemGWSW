...
<qgis styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyMaxScale="1" version="3.28.4-Firenze" minScale="100000000" simplifyLocal="1" simplifyDrawingTol="1" symbologyReferenceScale="-1" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" enableorderby="0" referencescale="-1">
    <symbols>
      <symbol type="line" force_rhr="0" is_animated="0" frame_rate="10" name="0" alpha="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <DiagramLayerSettings zIndex="0" dist="0" placement="2" showAll="1" priority="0" obstacle="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    <alias index="0" field="Rioolgemaal" name=""/>
    <alias index="1" field="Beginpunt_Afvoerrelatie" name=""/>
    <alias index="2" field="Eindpunt_Afvoerrelatie" name=""/>
    <alias index="3" field="Bemalingsgebied_ID_Afvoerpunt" name=""/>
    <alias index="4" field="Bemalingsgebied_ID_Lozingspunt" name=""/>
  </aliases>
  <defaults>
