...
class GeodynGwswStap3BepalenBovenstroomseGebiedenEnAfvalwateraanbod(QgsProcessingAlgorithmPost):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['FieldCalculatorX_obemal'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)

        feedback.setCurrentStep(8)
        if feedback.isCanceled():
            return {}

        # Field calculator X_OBEMAL_1N
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'X_OBEMAL_1N',
            'FIELD_PRECISION': 0,
            'FIELD_TYPE': 1,  # Integer (32 bit)
            'FORMULA': '0',
            'INPUT': outputs['FieldCalculatorX_obemal']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        outputs['FieldCalculatorX_obemal_1n'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        alg_params = {
            ...
            'FIELD_TYPE': 1,  # Integer (32 bit)
            'FORMULA': '0',
            'INPUT': outputs['FieldCalculatorX_obemal_1n']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        ...
        alg_params = {
            ...
            'OUTPUT': parameters['Onderbemaling_test']
        }
        ...
        results['Onderbemaling_test'] = outputs['FieldCalculatorUs_exafw_4050']['OUTPUT']
        ...
        alg_params = {
            ...
            'veldenlijst': 'POC_GEM_m3h;US_POC_GEM_m3h,POC_VGS_m3h;US_POC_VGS_m3h,DWA_BAG_m3h;US_DWA_BAG_m3h,PAR_DRINKWATER_m3h;US_PAR_DRINKWATER_m3h,ZAK_DRINKWATER_m3h;US_ZAK_DRINKWATER_m3h,TOT_DRINKWATER_m3h;US_TOT_DRINKWATER_m3h,VE_m3h;US_VE_m3h,ExAFV_2124;US_ExAFV_2124,ExAFV_3039;US_ExAFV_3039,ExAFV_4050;US_ExAFV_4050',
            'Output_layer': QgsProcessing.TEMPORARY_OUTPUT
        }
        ...
        # Field calculator TOT_BAG+POC_m3h
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'TOT_BAG+POC_m3h',
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("SOM_POC_GEM_m3h"+"SOM_POC_VGS_m3h"+"SOM_DWA_BAG_m3h",2)',
            'INPUT': outputs['FieldCalculatorSom_exafw_4050']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        outputs['FieldCalculatorTot_bagpoc_m3h'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)

        feedback.setCurrentStep(38)
        if feedback.isCanceled():
            return {}

        # Field calculator TOT_DRINKWATER+POC_m3h
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'TOT_DRINKWATER+POC_m3h',
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("SOM_POC_GEM_m3h"+"SOM_POC_VGS_m3h"+"SOM_TOT_DRINKWATER_m3h",2)',
            'INPUT': outputs['FieldCalculatorTot_bagpoc_m3h']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        outputs['FieldCalculatorTot_drinkwaterpoc_m3h'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)

        feedback.setCurrentStep(39)
        if feedback.isCanceled():
            return {}

        # Field calculator TOT_BAG+POC+PC_m3h
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'TOT_BAG+POC+PC_m3h',
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("SOM_POC_GEM_m3h"+"SOM_POC_VGS_m3h"+"SOM_DWA_BAG_m3h"+"SOM_ExAFW_2124"+"SOM_ExAFW_2529"+"SOM_ExAFW_3039"+"SOM_ExAFW_4050",2)',
            'INPUT': outputs['FieldCalculatorSom_exafw_4050']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        outputs['FieldCalculatorTot_bagpocpc_m3h'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)

        feedback.setCurrentStep(40)
        if feedback.isCanceled():
            return {}

        # Field calculator TOT_DRINKWATER+POC+PC_m3h
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'TOT_DRINKWATER+POC+PC_m3h',
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("SOM_POC_GEM_m3h"+"SOM_POC_VGS_m3h"+"SOM_TOT_DRINKWATER_m3h"+"SOM_ExAFW_2124"+"SOM_ExAFW_2529"+"SOM_ExAFW_3039"+"SOM_ExAFW_4050",2)',
            'INPUT': outputs['FieldCalculatorTot_bagpocpc_m3h']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        outputs['FieldCalculatorTot_drinkwaterpocpc_m3h'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)

        feedback.setCurrentStep(41)
        if feedback.isCanceled():
            return {}

        # Field calculator TOT_VE+POC+PC_m3h
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'TOT_VE+POC+PC_m3h',
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("SOM_POC_GEM_m3h"+"SOM_POC_VGS_m3h"+"SOM_VE_m3h"+"SOM_ExAFW_2124"+"SOM_ExAFW_2529"+"SOM_ExAFW_3039"+"SOM_ExAFW_4050",2)',
            'INPUT': outputs['FieldCalculatorTot_drinkwaterpocpc_m3h']['OUTPUT'],
            'OUTPUT': parameters['ResultaatStap3RioleringsgebiedenToekomstigeSituatieAfvalwateraanbod2050']
        }
        outputs['FieldCalculatorTot_vepocpc_m3h'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['ResultaatStap3RioleringsgebiedenToekomstigeSituatieAfvalwateraanbod2050'] = outputs['FieldCalculatorTot_vepocpc_m3h']['OUTPUT']

        feedback.setCurrentStep(42)
        if feedback.isCanceled():
            return {}

        # Field calculator TOT_VE+POC_m3h
        alg_params = {
            'FIELD_LENGTH': 0,
            'FIELD_NAME': 'TOT_VE+POC_m3h',
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("SOM_POC_GEM_m3h"+"SOM_POC_VGS_m3h"+"SOM_VE_m3h",2)',
            'INPUT': outputs['FieldCalculatorTot_drinkwaterpoc_m3h']['OUTPUT'],
            'OUTPUT': parameters['TussenresultaatHuidigeSituatieAfvalwateraanbod']
        }
        outputs['FieldCalculatorTot_vepoc_m3h'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['TussenresultaatHuidigeSituatieAfvalwateraanbod'] = outputs['FieldCalculatorTot_vepoc_m3h']['OUTPUT']
        ...
        alg_params = {
            ...
            'INPUT': outputs['FieldCalculatorTot_vepoc_m3h']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        ...
        alg_params = {
            ...
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("M3_StelselBerging"/min("SOM_DWA_BAG_m3h","SOM_TOT_DRINKWATER_m3h","SOM_VE_m3h"),2)',
        ...
        alg_params = {
            ...
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("M3_StelselBerging"/min("TOT_BAG+POC_m3h","TOT_DRINKWATER+POC_m3h","TOT_VE+POC_m3h"),2)',
        ...
        alg_params = {
            ...
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("M3_StelselBerging"/max("TOT_BAG+POC_m3h","TOT_DRINKWATER+POC_m3h","TOT_VE+POC_m3h"),2)',
        ...
        alg_params = {
            ...
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round("Pompcapaciteit"-min("SOM_DWA_BAG_m3h","SOM_TOT_DRINKWATER_m3h","SOM_VE_m3h")-("US_POC_GEM_m3h"+"US_POC_VGS_m3h"),2)',
        ...
        alg_params = {
            ...
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round(("MIN_POC_PRAKTIJK_m3h"/(("GEM_HA"+"VGS_ha")*10000))*10000,2)',
        ...
        alg_params = {
            ...
            'FIELD_PRECISION': 2,
            'FIELD_TYPE': 0,  # Decimal (double)
            'FORMULA': 'round(("MAX_POC_PRAKTIJK_m3h"/(("GEM_HA"+"VGS_ha")*10000))*10000,2)',
            'INPUT': outputs['FieldCalculatorMin_poc_praktijk_mmh']['OUTPUT'],
            'OUTPUT': parameters['ResultaatStap3RioleringsgebiedenSommatieAfvalwateraanbodBergingVultijdLedigingstijd']
        }
        ...
        results['ResultaatStap3RioleringsgebiedenSommatieAfvalwateraanbodBergingVultijdLedigingstijd'] = outputs['FieldCalculatorMax_poc_praktijk_mmh']['OUTPUT']
        ...
        alg_params = {
            ...
            'OUTPUT': parameters['ResultaatStap3AfvoerpuntenRioleringsgebiedenKenmerkenSommatieAfvalwateraanbodBergingVultijdLedigingstijd']
        }
        ...
        results['ResultaatStap3AfvoerpuntenRioleringsgebiedenKenmerkenSommatieAfvalwateraanbodBergingVultijdLedigingstijd'] = outputs['DropFieldsUs_bem_id_2']['OUTPUT']
